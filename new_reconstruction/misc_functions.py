...
class ResNetBackbone(nn.Module):
    def __init__(self, model_name):
        ...
        state_dict = torch.load(os.path.join('../models', self.model_name + '.pth'), map_location=torch.device('cpu'))
...
def get_example_params(example_index):
    ...
    example_list = (('/Users/chanmunfai/Documents/Imperial/Group Project/Code/SSL/saliency_map/example_images/snake.png', 56),
    ...
    # Define model
    # pretrained_model = models.alexnet(pretrained=True) # change this

    pretrained_model = ResNetBackbone("swav")

    device = "cpu"
    pretrained_model = pretrained_model.to("cpu") # change this to args.device later

    print(dir(pretrained_model.model))
