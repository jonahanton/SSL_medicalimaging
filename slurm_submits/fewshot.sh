...
python few_shot.py -d $dset -m moco-v2 --n-way 5 --n-support 20
...
python few_shot.py -d $dset -m supervised_r50 --n-way 5 --n-support 20
python few_shot.py -d $dset -m supervised_r18 --n-way 5 --n-support 20
python few_shot.py -d $dset -m supervised_d121 --n-way 5 --n-support 20
